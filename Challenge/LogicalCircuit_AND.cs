...
namespace Challenge
{
    public static class LogicalCircuit_AND
    {
        [FunctionName("LogicalCircuit_AND")]
            ...
            else
            {
                ...
                else
                {
                    if (binary1 == "1" && binary2 == "1")
                    {
                        return binary1 == null
                                        ? req.CreateResponse(HttpStatusCode.BadRequest, "Please pass a name on the query string or in the request body")
                                        : req.CreateResponse(HttpStatusCode.OK, "Result of the logic gate AND is True");
                    }
                    ...
                    if(binary1 == "0" && binary2 == "0")
                    {
                        return binary1 == null
                                        ? req.CreateResponse(HttpStatusCode.BadRequest, "Please pass a name on the query string or in the request body")
                                        : req.CreateResponse(HttpStatusCode.OK, "Result of the logic gate AND is False");
                    }
